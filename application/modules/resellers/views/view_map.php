...
function initialize() {
    if (GBrowserIsCompatible()) {	
		...
		map.setCenter(new GLatLng(<?php echo $reseller->latitude?>,<?php echo $reseller->longitude?>), <?php echo $reseller->zoom?>);
		
		/* สร้างหมุดปักโดยมีสัญกรแบบปริยาย */
		map.addOverlay(new GMarker(new GLatLng(<?php echo $reseller->latitude?>,<?php echo $reseller->longitude?>), <?php echo $reseller->zoom?>));
    }
 }
</script>
</head>
