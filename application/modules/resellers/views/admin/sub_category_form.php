...
<h1 style="margin:0 0 15px;">ตัวแทนจำหน่าย » ศูนย์ภูมิภาค  » <?php echo lang_decode($parent->name) ?></h1>
<form method="post" action="resellers/admin/categories/sub_categories_save/<?php echo $category->id?>" enctype="multipart/form-data">
	<table class="form">
