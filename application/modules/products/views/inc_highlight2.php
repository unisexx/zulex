	...
	<?php foreach($products as $product):?>
		...
		<div class="content">
        		<div style="float:left; margin:0 18px 0 0;">
                    <a href="products/product_detail/<?php echo $product->id?>"><img src="uploads/products/<?php echo $product->image?>" width="96" height="53"></a>
                    <div align="center" class="title"><a href="products/product_detail/<?php echo $product->id?>"><?php echo lang_decode($product->title)?></a></div>
                </div>
				<div class="detail"><a href="products/product_detail/<?php echo $product->id?>"><?php echo lang_decode($product->highlight2_detail)?></a></div>
		</div>
