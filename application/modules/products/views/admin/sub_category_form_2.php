...
<h1 style="margin:0 0 15px;">สินค้า » หมวดหมู่  » <?php echo lang_decode($sub_categories_1->name)?> » <?php echo lang_decode($parent->name) ?></h1>
<form method="post" action="products/admin/categories/sub_categories_save_2/<?php echo $sub_categories_1->id?>/<?php echo $category->id?>" enctype="multipart/form-data">
	<table class="form">
